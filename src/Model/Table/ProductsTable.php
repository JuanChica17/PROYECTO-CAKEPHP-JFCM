...
class ProductsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->allowEmptyString('code_product')
            ->add('code_product', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);

        $validator
            ->scalar('name_product')
            ->maxLength('name_product', 15)
            ->allowEmptyString('name_product');

        $validator
            ->scalar('category_product')
            ->maxLength('category_product', 15)
            ->allowEmptyString('category_product');

        $validator
            ->decimal('price_product')
            ->allowEmptyString('price_product');
    ...
    {
        $rules->add($rules->isUnique(['code_product']), ['errorField' => 'code_product']);
